...
public class Complex {
	...
	public Complex normalised() throws Exception {
		if (getIm()==0 && getRe()==0) {
			throw new Exception("Cannot calculate modulus of zero complex number");
		}
	...
	public static Complex multiply(Complex a, Complex b) throws Exception {
	...
	public static Complex divide(Complex a, Complex b) throws Exception {
		if (b.getIm()==0 && b.getRe()==0) {
			throw new Exception("Cannot divide by " + b.getRe() + " + " + b.getIm() + "i");
		}
